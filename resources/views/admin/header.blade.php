<nav class="navbar p-0 fixed-top d-flex flex-row">
    ...
    <ul class="navbar-nav w-100">
        ...
        <form action="{{ url('search_product') }}" method="GET" class="nav-link mt-2 mt-md-0 d-none d-lg-flex search">
          @csrf
            <input style="margin-right: 10px;" type="text" name="search" class="form-control" placeholder="Search products">
            <input style="color: gray;" type="submit" class="btn" value="Search">
        </form>
        </li>
    </ul>
        ...
        <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="createbuttonDropdown">
          ...
          <a class="dropdown-item preview-item" href="{{ url('view_product') }}">
            ...
            <div class="preview-item-content">
              <p class="preview-subject ellipsis mb-1">Create Product</p>
            </div>
          </a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item preview-item" href="{{ url('view_category') }}">
            ...
            <div class="preview-item-content">
              <p class="preview-subject ellipsis mb-1">Create Category</p>
            </div>
          </a>
          {{-- <div class="dropdown-divider"></div>
